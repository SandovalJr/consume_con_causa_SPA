...
@Component({
  selector: 'app-ventas-productos-np',
  templateUrl: './ventas-productos-np.component.html',
  styleUrls: ['./ventas-productos-np.component.scss']
})
export class VentasProductosNPComponent implements OnInit {
