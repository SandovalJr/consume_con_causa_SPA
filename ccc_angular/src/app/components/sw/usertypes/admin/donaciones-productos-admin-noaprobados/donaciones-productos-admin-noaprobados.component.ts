...
@Component({
  selector: 'app-donaciones-productos-admin-noaprobados',
  templateUrl: './donaciones-productos-admin-noaprobados.component.html',
  styleUrls: ['./donaciones-productos-admin-noaprobados.component.scss']
})
export class DonacionesProductosAdminNOAPROBADOSComponent implements OnInit {
